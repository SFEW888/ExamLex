...
- `skills/examlex/assets/`: templates, JSON schemas, vocabulary pools, test word lists, common error patterns, and sample essays.
...
- `skills/examlex/assets/data/vocabulary/`: verified, count-bearing pools for CET-4 (3,331), CET-6 (3,650), and Postgraduate English (1,014), plus 100-entry curated starter pools for TEM-4 and TEM-8.
...
- `skills/examlex/scripts/`: the canonical, portable implementation package.
- `examlex/`: a thin historical import and CLI bridge; it contains no copied scripts or resources.
