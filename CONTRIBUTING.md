...
Thank you for helping improve English Exam AI Tutor.
...
- Keep `skills/english-exam-ai-tutor/` portable: `SKILL.md`, `scripts/`, `references/`, and `assets/` only.
- Keep private prompt bodies out of public files. Use placeholders such as `[PRIVATE_PROMPT_PLACEHOLDER: grammar-corrector]`.
- Mirror automation script changes between `skills/english-exam-ai-tutor/scripts/` and `skills/english_exam_ai_tutor/scripts/`.
