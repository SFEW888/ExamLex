...
This is a shortcut Skill for the grammar correction assistant in `english-exam-ai-tutor`.
...
For learner text, produce a correction report with original sentence, corrected sentence, and a concise explanation. Preserve the learner's intended meaning and tag repeated causes with writing or translation error tags from `../english-exam-ai-tutor/references/error-taxonomy.md`.
