...
distractor rejection together. This layout is a project-authored quality
contract, not an evidence source, so it receives no evidence grade.
...
> references + `R` translation/terminology/cultural-background/writing references
> + newly written passages and questions.
...
- **Reference use:** an `R` corpus informed terminology, translation, cultural background, or writing; it was not treated as an official question bank or direct question source.
