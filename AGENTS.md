...
- Preserve the eight assistant roles and placeholder identifiers under `skills/english-exam-ai-tutor/references/assistant-roster.md`.
- Do not add `README.md` or `INSTALL.md` inside `skills/english-exam-ai-tutor/`.
