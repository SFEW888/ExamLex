...
```bash
# 验证 TEM-8 学习者档案
tutor check tem8-learner-profile.json

# 生成 TEM-8 每日计划（含计时训练）
tutor plan tem8-learner-profile.json \
  --ability tem8-ability-profile.json \
  --vocab-pool skills/english-exam-ai-tutor/assets/data/vocabulary/tem8-core-2000.json \
