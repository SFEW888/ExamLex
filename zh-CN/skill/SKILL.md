...
关键词推敲、成句步骤、对齐参考译文和替代表达。按照标准中的四级、六级、考研、专四、
专八具名专项 playbook 执行，并在交付前校验答案唯一性及答案、证据、翻译和解析的一致性。
...
### 7f. Darwin 评分与审批门禁
- Structure (59 pts): auto-scored by `python run.py validate` via `validators/darwin_structure.py`
