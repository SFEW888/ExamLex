...
之后在四级、六级或考研英语任务中使用已安装的 `examlex` Skill。如果是在当前仓库内开发或调试，也可以直接运行本地脚本。
...
python -m examlex update-ability --ability ability-profile.json --ledger practice-ledger.json --output ability-profile.next.json
```
