...
> ExamLex's repository-defined rubric for strategy structure, effectiveness, and meta-skill quality.
...
| 6 | Resource integration | 4 | Local source identifiers and categorization tags. |
...
The executable rules in `validators/darwin_structure.py`, `prompts/effect.py`, and the tests are authoritative. This document explains those local rules and does not require an external source.
